...
public class ToPracticeDragAndDrop {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement accepted_ele = driver.findElement(By.xpath("//iframe[@class='demo-frame lazyloaded']")); //Switching to frame
		driver.switchTo().frame(accepted_ele);
		...
		WebElement pro = driver.findElement(By.xpath("//iframe[@class='demo-frame lazyloaded']")); //Switching to frame
		driver.switchTo().frame(pro);
		WebElement drag1 = driver.findElement(By.linkText("Drag me to my target"));
		WebElement drop2 = driver.findElement(By.id("droppable2-inner"));
